 ...
 *
 */
#ifndef _RXP_API_INT_H_
#define _RXP_API_INT_H_
 ...
 */
struct rxp_job_batch *rxp_job_batch_alloc_int(size_t max_jobs, size_t bytes_threshold);
 ...
 */
int rxp_open_int(unsigned rxp, struct ibv_context *ctx);
 ...
 */
int rxp_program_rules_int(unsigned rxp, const char *rulesfile, bool incremental, struct ibv_context *ctx);
 ...
 * @param incremental Indicate whether this is an incremental update, and thus that the RXP should not be reset.
 */
int rxp_program_rules_struct_int(unsigned rxp, const struct rxp_rof *rof, bool incremental);
 ...
 */
int rxp_read_stats_int(unsigned rxp, struct rxp_stats *stats);
 ...
 * @param stats Pointer to the structure which will hold the retrieved statistics.
 */
int rxp_read_perf_stats_int(unsigned rxp, struct rxp_perf_stats *stats);
 ...
 */
int rxp_read_max_matches_int(unsigned rxp, uint32_t *max_matches);
 ...
 */
int rxp_set_max_matches_int(unsigned rxp, uint32_t max_matches);
 ...
 */
int rxp_read_max_prefixes_int(unsigned rxp, uint32_t *max_prefixes);
 ...
 */
int rxp_set_max_prefixes_int(unsigned rxp, uint32_t max_prefixes);
 ...
 */
int rxp_read_max_latency_int(unsigned rxp, uint32_t *max_latency);
 ...
 */
int rxp_set_max_latency_int(unsigned rxp, uint32_t max_latency);
 ...
 */
int rxp_read_max_pri_threads_int(unsigned rxp, uint32_t *max_pri_threads);
 ...
 */
int rxp_set_max_pri_threads_int(unsigned rxp, uint32_t max_pri_threads);

#ifdef __cplusplus
}
#endif

#endif /* _RXP_API_INT_H_ */
