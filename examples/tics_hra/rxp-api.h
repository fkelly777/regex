/**
 * @file   rxp-api.h
 * @author Mellanox Technologies Ltd <support@mellanox.com>
 *
 */
#ifndef _RXP_API_H_
#define _RXP_API_H_
 ...
 *
 * The Mellanox Regular eXpression Processor (RXP) is a custom-purpose processor
 ...
 * application utilising the Mellanox RXP. It documents the C API for
 ...
 *
 * This function performs any platform specific initialisation appropriate to the given RXP.
 * An array of argument strings can be supplied.
 *
 * @param rxp         RXP instance to use. Usually 0, unless there are multiple RXPs present in the system.
 * @param argc        Number of arguments
 * @param argv        Array of argument strings
 */
int rxp_platform_init(unsigned rxp, int argc, char *argv[]);

/**
 * Platform specific clean-up.
 *
 * This function performs any platform specific clean-up appropriate to the given RXP.
 *
 * @param rxp         RXP instance to use. Usually 0, unless there are multiple RXPs present in the system.
 */
int rxp_platform_uninit(unsigned rxp);
