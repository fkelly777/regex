/*
 * rxp.h - Public API definitions for the Mellanox RXP
 *
...
#define RXP_API_VERSION "20.02.2"
...
struct rxp_response {
	...
	struct rxp_match_tuple matches[];
};
...
#define RXP_CTL_MODE_EM_PRIVATE 1
#define RXP_CTL_MODE_EM_SHARED 2
